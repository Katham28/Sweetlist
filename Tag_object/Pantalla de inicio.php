...
<?php
	...
	if (isset ($_SESSION["LoginError"])){
		if($_SESSION["LoginError"]==true){
			...
			echo "<span style='color:red'> Login Error.</span><br\>";
        ...
        <div class="row">
            ...
            <div class="col-12 col-md-6 mb-3">
                <div class="p-3 girly-fields d-flex flex-column justify-content-center">
                    ...
                    <button class="button d-block mx-auto" onclick="irPantallaCRUD_Usuario()">
                         CRUD USERS
                    </button>
                    <p class="text-center mt-3 text-muted">Manage, create, update or delete users</p>
                </div>
            </div>
        </div>
    </div>
