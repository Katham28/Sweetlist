...
<div id="container">
    ...
    <div class="p-3 girly-fields">
        ...
        <button class="button d-block mx-auto mt-3" onclick="searchTask()">SEARCH</button>
    </div>
...
function searchTask(){
    ...
    fetch('CRUD_task_Search.php', {
        method: 'POST',
        headers: { 'Content-Type': 'application/x-www-form-urlencoded' },
        body: 'tittleA=' + encodeURIComponent(value)
    })
    .then(r => r.text())
    .then(html => {
        const tbody = document.getElementById('searchResults');
        tbody.innerHTML = html.trim() !== '' ? html : '<tr><td colspan="6" class="text-center text-muted">No results</td></tr>';
    });
}
</script>
